...
int main(void)
{
   ...
   //No match with salary
   matchPtr = searchEmployeeBySalary(EmployeeTable, EmployeeTableEntries, 8.3);
   if (matchPtr != NULL)
      printf("Employee with salary %.2f is in record %d\n", "714-555-2759", 8.3, matchPtr - EmployeeTable);
   else
